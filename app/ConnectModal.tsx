    ...
    const renderWalletConnectorGroup = () => {
        return wallets.map((wallet) => {
            ...
            return (
                ...
                >
                    <li>
                        <div className='flex items-center p-3 text-base font-bold text-gray-900 bg-gray-500 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-900 dark:hover:bg-gray-500 dark:text-white'>
                            <button
                                onClick={() => {
                                    connect(option.name)
                                    setConnectModalOn(false)
        ...
        <div className="bg-opacity-80 backdrop-blur-sm overflow-y-auto overflow-x-hidden fixed flex items-center justify-center z-50 w-full md:inset-0 h-modal md:h-full">
            <div className="relative p-4 w-full max-w-md h-full md:h-auto">
                ...
                <div ref={clickOutsideRef} className="relative bg-black rounded-lg shadow dark:bg-black-700">
                    ...
                    <div className="p-6">
                        <p className="text-sm font-normal text-gray-500 dark:text-gray-400">Connect with one of the following wallets.</p>
