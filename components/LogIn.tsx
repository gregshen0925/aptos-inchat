...
const LogIn = (props: Props) => {
  const [text, count] = useTypewriter({
    words: [`Perfect Showcase For Aptos Token Design`,`Developed By InJoy Labs`],
    delaySpeed: 100,
  });
    ...
    <div>
      ...
      >
        ...
        <div className="">
          ...
          <Cursor /> */}
          <h1 className="pb-2 text-2xl md:text-5xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-blue-800 to-blue-300 px-10 ">
